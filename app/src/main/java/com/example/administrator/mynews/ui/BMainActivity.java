...
public class BMainActivity extends AppCompatActivity implements OnClickListener {
        ...
        switch (v.getId()) {
            ...
            case R.id.send:
                ...
                if (TextUtils.isEmpty(input)) {
                    Toast.makeText(BMainActivity.this, R.string.empty_prompt, Toast.LENGTH_SHORT).show();
                } else {
