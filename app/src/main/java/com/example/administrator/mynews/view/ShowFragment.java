...
public class ShowFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        web= (WebView) view.findViewById(R.id.show_wed);
//        mUrl = getIntent().getStringExtra("url");
//        mTitle = getIntent().getStringExtra("title");
//        mImg = getIntent().getStringExtra("img");
        tv= (TextView)  view.findViewById(R.id.show_tob_tv);
        ...
        FloatingActionButton fb= (FloatingActionButton)  view.findViewById(R.id.show_float);
